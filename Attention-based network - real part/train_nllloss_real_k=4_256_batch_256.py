...
class Dataset_torch(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        inputs = [torch.unsqueeze( self.data['x1'][:,0,:,:],dim=1)[idx],self.data['x2'][idx].float()]
...
class Net_comb(pl.LightningModule):
    ...
    def forward(self, x1,x2):
        ...
        cnn_output_matrix = torch.cat([cnn_output_n1,cnn_output_n2,cnn_output_n3,cnn_output_n4],dim=1)
        cnn_output_matrix = cnn_output_matrix.view(-1,4,256)
...
monitor='val_loss',
dirpath='./model/model_nllloss_real_k=4_256_batch_256/',
