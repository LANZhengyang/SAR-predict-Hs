...
class Net_spectral(pl.LightningModule):
    def __init__(self):
        ...
        self.fc1024_n1 = nn.Linear(1024, 1024)
        self.fc1024_n2 = nn.Linear(1024, 1024)
    ...
    def forward(self, x):
        ...
        x = F.relu(self.fc1024_n1(torch.squeeze(x)))
        x = F.relu(self.fc1024_n2(x))
        x = self.dropout(x)
        return x
...
class Net_cwave(pl.LightningModule):
    def __init__(self):
        ...
        self.fc256_n4 = nn.Linear(256, 512)
        self.fc256_n5 = nn.Linear(512, 512)
        self.fc256_n6 = nn.Linear(512, 512)
        self.fc256_n7 = nn.Linear(512, 1024)
        self.fc256_n8 = nn.Linear(1024, 1024)
        self.fc256_n9 = nn.Linear(1024, 1024)
        self.fc256_n10 = nn.Linear(1024, 1024)
...
class Net_comb(pl.LightningModule):
    def __init__(self):
        ...
        self.fc2048_1024 = nn.Linear(2048,1024)
...
checkpoint_callback = ModelCheckpoint(
    monitor='val_loss',
    dirpath='./model/models_orignal_mean_var_filter1024_first_256_batch_256_mp',
...
trainer = pl.Trainer(gpus=[1], max_epochs=100, progress_bar_refresh_rate=20,callbacks=[early_stop_callback,lr_monitor,checkpoint_callback])
