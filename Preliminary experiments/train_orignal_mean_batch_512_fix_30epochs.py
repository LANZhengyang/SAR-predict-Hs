...
data_loader_1517 = torch.utils.data.DataLoader(dataset=dataset_1517, batch_size=512,shuffle=True,num_workers=2)
...
class Net_comb(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        loss = F.mse_loss(y_pre[:,0], torch.squeeze(y_true).float())
...
trainer = pl.Trainer(gpus=1, max_epochs=30, progress_bar_refresh_rate=200,callbacks=[lr_monitor], default_root_dir='./model/model_mean_batch_512_fix_epoch_m20/')
