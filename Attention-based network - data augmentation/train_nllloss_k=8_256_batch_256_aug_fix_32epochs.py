...
trainer = pl.Trainer(gpus=[2], max_epochs=32, progress_bar_refresh_rate=200,callbacks=[lr_monitor], default_root_dir='./model/model_nllloss_k=8_256_batch_256_aug_fix_32epoch_p5_lr08/')
