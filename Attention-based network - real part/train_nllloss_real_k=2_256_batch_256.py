...
class Net_comb(pl.LightningModule):
    ...
    def forward(self, x1,x2):
        ...
        cnn_output_matrix = torch.cat([cnn_output_n1,cnn_output_n2],dim=1)
        cnn_output_matrix = cnn_output_matrix.view(-1,2,256)
...
checkpoint_callback = ModelCheckpoint(
    monitor='val_loss',
    dirpath='./model/model_nllloss_real_k=2_256_batch_256/',
