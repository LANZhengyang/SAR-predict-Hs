...
checkpoint_callback = ModelCheckpoint(
    monitor='val_loss',
    dirpath='./model/model_nllloss_k=1_256_batch_256/',
...
trainer = pl.Trainer(gpus=[0], max_epochs=100, progress_bar_refresh_rate=200,callbacks=[early_stop_callback,lr_monitor,checkpoint_callback])
