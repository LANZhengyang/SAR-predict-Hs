...
checkpoint_callback = ModelCheckpoint(
    monitor='val_loss',
    dirpath='./model/models_orignal_mean_var_batch_256_mp_32features_aug',
...
trainer = pl.Trainer(gpus=[2], max_epochs=100, progress_bar_refresh_rate=200,callbacks=[early_stop_callback,lr_monitor,checkpoint_callback])
