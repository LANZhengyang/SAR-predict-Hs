...
class Net_comb(pl.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=2, gamma=0.9, verbose=True)
...
trainer = pl.Trainer(gpus=[2], max_epochs=40, progress_bar_refresh_rate=200,callbacks=[lr_monitor], default_root_dir='./model/model_nllloss_real_k=8_256_batch_256__fix_epoch_40_v1/')
